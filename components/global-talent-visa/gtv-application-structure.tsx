  ...
  return (
    <section className="border-b border-rule">
      <div className="px-6 py-10 md:px-12 md:py-14">
        <div className="flex flex-col gap-8 md:grid md:grid-cols-[0.95fr_1.05fr] md:items-start md:gap-16">
          <FadeIn delay={0.1} className="flex flex-col gap-5">
            <GTVSectionLabel>Submission Pack</GTVSectionLabel>
            <h2
          ...
          <FadeIn delay={0.2}>
            <div className="space-y-4 text-[0.78rem] leading-[1.85] text-muted md:text-[0.88rem]">
              <p>
              ...
              <div className="border-l-[3px] border-accent bg-cream px-5 py-5">
      ...
      <div className="border-t border-rule px-6 py-10 md:px-12 md:py-14">
        <div className="flex flex-col gap-12 md:grid md:grid-cols-[0.9fr_1.1fr] md:gap-16">
          <FadeIn delay={0.1}>
            <div>
              <span className="font-mono text-[0.6rem] tracking-[0.18em] text-muted uppercase">
                Core Pack / 3 Documents
              </span>
              <h3 className="mt-4 mb-6 max-w-sm text-[1rem] leading-tight font-bold">
              ...
              <div className="border-t border-rule">
                {coreDocs.map((doc, index) => (
                  <motion.article
                    key={doc.num}
                    className="border-b border-rule py-5 md:pr-8"
            ...
            <div>
              ...
              <div className="grid border-t border-rule md:grid-cols-2">
                {evidenceItems.map((item, index) => (
                  <motion.article
                    key={item.title}
                    className="border-b border-rule py-4 md:pr-6"
